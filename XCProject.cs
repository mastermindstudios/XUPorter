    ...
    public partial class XCProject : System.IDisposable
    {
        ...
        public void ApplyMod(XCMod mod)
        {
            ...
            foreach (XCModFile libRef in mod.libs)
            {
                ...
                {
                    completeLibPath = Path.Combine("usr/lib", libRef.filePath);
                }
                else
                {
                    completeLibPath = Path.Combine(mod.path, libRef.filePath);
                }

                AddFile(completeLibPath, modGroup, libRef.sourceTree, true, libRef.isWeak);
            }
